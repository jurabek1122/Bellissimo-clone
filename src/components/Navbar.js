                        ...
                        <div className="navlinkbg">
                         ...
                         <div>
                            ...
                            <Link to='/'>
                                ...
                                <Link to="/card" className='dnone'>
                                    <div className={fixed ? 'nav-number none' : 'nav-number '}>
                                        <HiShoppingCart />
                                        <p>{cart.length}</p>
                                    </div>
                                </Link>
                                ...
                                <div className={isNavExpanded ? "navigation-menu expanded" : "navigation-menu"}>
                                    <ul>
                                    <li>
                                        <a href="#"><ImEnter />Kirish</a>
                                    </li>
                                    <li>
                                        <a href="#"><MdRestaurantMenu />Taomnoma</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src={sale} alt='sale' className='sale' />Aksiyalar</a>
                                    </li>
                                    <li>
                                        <a href="#"><GiPizzaCutter />Yarim bo`lak konstruktori</a>
                                    </li>
                                    <li>
                                        <a href="#"><FaRegBuilding />Restoranlar</a>
                                    </li>
                                    <li>
                                        <a href="#"><button className='nav-btn'>
                                            <FaPhoneAlt />
                                            Bizga qo`ng`iroq
                                            </button></a>
                                    </li>
